...
@implementation TCScannerBorder
{
    /// 冲击波图像
...
//    NSBundle *imageBundle = [NSBundle bundleWithURL:url];
    ...
    // 冲击波图像
    //scannerLine = [[UIImageView alloc] initWithImage:[self imageWithName:@"QRCodeScanLine" bundle:[NSBundle mainBundle]]];
...
//        UIImageView *img = [[UIImageView alloc] initWithImage:[self imageWithName:imgName bundle:[NSBundle mainBundle]]];
